    ...
    public function run()
    {
        ...
        for ($i = 1; $i <= 50; $i++) {
            ...
            $umkm = Usaha::create([
                ...
                'kecamatan_id' => 1,
                'kelurahan_id' => 1,
                'kordinat_usaha' => 'https://maps.app.goo.gl/qwpk476LsEnZcH1r9',
                'rt' => '01',
                'rw' => '02',
            ]);
            ...
            Keuangan::create([
                'usaha_id' => $umkm->id,
                'modal_usaha' => rand(10000000, 50000000), 
                'asset_usaha' => rand(11000000, 55000000),
                'penghasilan_bulanan' => rand(5000000, 20000000), 
                'penghasilan_tahunan' => rand(60000000, 240000000), 
                'jumlah_tenaga_kerja' => rand(5, 20), 
            ]);
        }
    }
}
